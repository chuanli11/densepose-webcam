...
def im_detect_all(model, im, box_proposals, timers=None):
    ...
    print('im_detect_bbox: {}'.format(timers['im_detect_bbox'].average_time))
    print('misc_bbox: {}'.format(timers['misc_bbox'].average_time))
    print('im_detect_mask: {}'.format(timers['im_detect_mask'].average_time))
    print('misc_mask: {}'.format(timers['misc_mask'].average_time))
    print('im_detect_keypoints: {}'.format(timers['im_detect_keypoints'].average_time))
    print('misc_keypoints: {}'.format(timers['misc_keypoints'].average_time))
    print('im_detect_body_uv: {}'.format(timers['im_detect_body_uv'].average_time))
...
def im_detect_bbox(model, im, target_scale, target_max_size, boxes=None):
    ...
    print("_get_blobs: {}".format(end - start))
